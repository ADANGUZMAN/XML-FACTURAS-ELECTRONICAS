...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblEscuelaPolitcnicaNacional.setFont(new Font("Arial Black", Font.ITALIC, 15));
		lblEscuelaPolitcnicaNacional.setHorizontalAlignment(SwingConstants.CENTER);
		lblEscuelaPolitcnicaNacional.setBounds(95, 0, 263, 28);
		...
		lblAplicacionesEnAmbientes.setBounds(105, 50, 251, 28);
		contentPane.add(lblAplicacionesEnAmbientes);

		JLabel lblPeriodoAcademico = new JLabel("PERIODO ACADÉMICO 2017-A");
		...
		lblCapturadorDeFacturas.setFont(new Font("Tw Cen MT", Font.BOLD, 16));
		...
		JLabel lblFecha = new JLabel("FECHA 15/06/2017");
